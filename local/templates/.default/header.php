...
<head>
	...
	<?
		...
		//Stylesheets 
		Asset::getInstance()->addCss("/local/templates/main/style/easy-responsive-tabs.css");
		Asset::getInstance()->addCss("/local/templates/main/style/jquery.fancybox.min.css");
		Asset::getInstance()->addCss("/local/templates/main/style/jquery-ui.css");
		Asset::getInstance()->addCss("/local/templates/main/style/main.css");
		Asset::getInstance()->addCss("/local/templates/main/style/normalize.min.css");
		Asset::getInstance()->addCss("/local/templates/main/style/slick.css");
		...
		//Scripts
		 ...
		 Asset::getInstance()->addJs("/local/templates/main/js/slick.min.js");
		 Asset::getInstance()->addJs("/local/templates/main/js/jquery.fancybox.min.js"); 
		 Asset::getInstance()->addJs("/local/templates/main/js/jquery-ui.min.js"); 
		 Asset::getInstance()->addJs("/local/templates/main/js/easyResponsiveTabs.js"); 
			...
			<div class="header-main-content clearfix">
				...
				<div class="header-main-contacts clearfix">
					<div class="header-phone-wrap aligner">
						...
						<div class="phone"><a href="tel:88007005030">8 800 700 50 30</a></div>
					</div>

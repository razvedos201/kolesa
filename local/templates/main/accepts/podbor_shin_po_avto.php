	...
	<div class="wrapper">
		...
		<main class="content">
			<div class="container">
				...
				<h1>Подбор легковых шин по авто</h1>

				<div class="content-info table">
					<div class="table-cell">
						<div class="content-info-title">
							<div class="aligner">Как определить типоразмер шин</div>
							<div class="aligner">
								<div class="hint">
						...
						<div class="filter-toggle">
							<div class="tabs-wrap js-tabs-wrap">
								<ul class="tabs-list js-tabs-list clearfix">
									<li class="current">По размеру</li>
									<li>По авто</li>
								</ul>
									...
									<div class="box box-visible">
										...
										<div class="filter-sidebar-block">
											<div class="flex-box">
												...
												<a href="#" class="btn btn-1 btn-gray">Сбросить</a>
											</div>
										</div>
									</div>
									<div class="box">
										<form action="#">
											<div class="filter-sidebar-block">
												<div class="filter-group">
													<select name="" id="">
														<option value="">Производитель авто</option>
														<option value="">Производитель авто</option>
														<option value="">Производитель авто</option>
													</select>
												</div>
